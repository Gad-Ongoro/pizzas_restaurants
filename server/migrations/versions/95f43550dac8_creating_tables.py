...
Revision ID: 95f43550dac8
Revises: 
Create Date: 2024-01-21 13:51:58.299221
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['rest_id'], ['restaurants.id'], name=op.f('fk_restaurant_pizza_rest_id_restaurants')),
    sa.PrimaryKeyConstraint('id')
    )
